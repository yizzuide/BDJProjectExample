...
typedef enum : NSUInteger {
    XMGPostDataMediaTypeAll = 1,
    XMGPostDataMediaTypePictrue = 10,
    XMGPostDataMediaTypeWords = 29,
    XMGPostDataMediaTypeVoice = 31,
    XMGPostDataMediaTypeVideo = 41
} XMGPostDataMediaType;

@interface XMGPostModel : NSObject
...
/** 帖子的类型，1为全部 10为图片 29为段子 31为音频 41为视频 */
@property (nonatomic, assign) XMGPostDataMediaType  type;
