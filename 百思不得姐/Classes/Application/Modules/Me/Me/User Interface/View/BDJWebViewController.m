...
@interface BDJWebViewController () <UIWebViewDelegate,NJKWebViewProgressDelegate>
...
- (void)viewDidLoad {
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:self.componentData]];
