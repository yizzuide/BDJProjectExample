...
@implementation XMGRecommendTagProvider

+ (XFRenderData *)collectRenderDataFromArray:(NSArray<XMGRecommendTagModel *> *)array {
    NSArray *list = [[array.rac_sequence map:^id(XMGRecommendTagModel *recommendTagModel) {
        XMGRCTagRenderItem *renderItem = [[XMGRCTagRenderItem alloc] init];
